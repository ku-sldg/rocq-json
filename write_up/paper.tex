...
\begin{abstract}
  ...
  JSON that automatically generates \texttt{Jsonifiable} instances
  ...
  value succeeds with the original value. The contribution is a
  performance-conscious and easily usable engineering tool for mapping
  Rocq data to a JSON interchange format, while preserving an explicit
  correctness theorem.
