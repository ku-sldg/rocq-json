...
If derivation is requested outside the supported contract, the command raises an
ordinary Rocq error.  Deliberate non-targets include targets in \texttt{Prop},
function-valued fields, sort-valued fields, and coinductive declarations.
Current limitations include dependent constructor fields, indexed families, and
proof-bearing computational wrappers.  A typical dependent-field diagnostic
looks like:
